            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):        
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        c1, c2 = (int(xyxy[0]), int(xyxy[1])), (int(xyxy[2]), int(xyxy[3]))
                        bboxCenter = [(320-80-120), (240-100), (320+80+170), (240+100)]
                        bbox_2 = [c1[0], c1[1], (c2[0]-c1[0]), (c2[1]-c1[1])]
                        bbox_1 = [bboxCenter[0], bboxCenter[1], (bboxCenter[2]-bboxCenter[0]), (bboxCenter[3]-bboxCenter[1])]
                        #calculator iou 
                        ...
                        elif iou >= 0.9 and Run_buffer == 25 or iou >= 0.3 and Run_buffer % 25 == 0:
